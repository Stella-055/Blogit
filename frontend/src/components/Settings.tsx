...
const Settings = () => {
  ...
  return (
    <div className="flex flex-wrap justify-center items-center gap-4">
      ...
      <div className="flex items-center mt-6 w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6  pr-6 gap-2">
            ...
            />
            {visibility1?<FaEye size={20} onClick={()=> setVisibility1(!visibility1)}/>: <FaEyeSlash size={20} onClick={()=> setVisibility1(!visibility1)}/>}
 ...
 {visibility2?<FaEye size={20} onClick={()=> setVisibility2(!visibility2)}/>: <FaEyeSlash size={20} onClick={()=> setVisibility2(!visibility2)}/>}
 ...
 {visibility3?<FaEye size={20} onClick={()=> setVisibility3(!visibility3)}/>: <FaEyeSlash size={20} onClick={()=> setVisibility3(!visibility3)}/>}
            
          </div>
          <Button variant="contained" sx={{mt:"1rem"}} loading={isPending} onClick={submitpassword} fullWidth>Update password</Button>
      </div>
    </div>
  )
}
