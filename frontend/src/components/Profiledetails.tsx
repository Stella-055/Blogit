...
const Profiledetails = () => {
  return (
    <form className="flex flex-col items-center text-sm text-slate-800 h-full">
    <p className="text-xs bg-blue-200 text-blue-600 font-medium px-3 py-2 rounded-full my-2">Your Details</p> 
    ...
    <div className="max-w-96 w-full px-4">
        ...
        <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-gray-400 rounded-full focus-within:ring-2 focus-within:ring-gray-400 transition-all overflow-hidden">
            ...
            <input type="text" id="name" className="h-full px-2 w-full outline-none bg-transparent text-gray-500" value="stella" />
        </div>
        ...
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <input id="lastname" type="email" className="h-full text-gray-500 px-2 w-full outline-none bg-transparent" value="stephanie"/>
        </div>
        ...
        <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-gray-400 rounded-full focus-within:ring-2 focus-within:ring-gray-400 transition-all overflow-hidden">
            ...
            <input id="email" type="email" className="h-full  text-gray-500 px-2 w-full outline-none bg-transparent" value="stella@gmail.com"/>
        </div>
        ...
        <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-gray-400 rounded-full focus-within:ring-2 focus-within:ring-gray-400 transition-all overflow-hidden">
            ...
            <input id="password" type="password" className="h-full text-gray-500 px-2 w-full outline-none bg-transparent" value="stephanie"/>
        </div>
        <Button
            variant="contained"
            fullWidth
