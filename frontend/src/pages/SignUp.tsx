...
<div className=" flex flex-col items-center justify-center p-2 ">
    ...
    <form className="md:w-96 w-80 flex flex-col items-center justify-center">
        ...
        <p className="text-sm text-gray-500/90 mt-3">Welcome To BlogIt! Please sign up to continue</p>
        ...
        <div className="flex items-center w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2 ">
           <RiContactsLine color='gray'/>
            <input type="text" placeholder="First Name" className="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" required/>                 
        </div>
        ...
        <RiContactsLine color='gray'/>
            <input type="text" placeholder="Second Name" className="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" required/>                 
        </div>
        <div className="flex items-center w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2 mt-4">
        <RiContactsLine color='gray'/>
            <input type="text" placeholder="User Name" className="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" required/>                 
        </div>
        <div className="flex items-center w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2 mt-4">
      ...
      <Button variant="contained" fullWidth sx={{borderRadius:"10px",marginTop:"1rem"}}> Create Account</Button>
        <p className="text-gray-500/90 text-sm mt-4">Already have an account? <a className="text-indigo-400 hover:underline" href="Signin">Sign In</a></p>
    </form>
</div>
</div>
